...
## [0.12.1](https://github.com/coder/ai-sdk/compare/agent-v0.12.0...agent-v0.12.1) (2026-09-26)

A patch release with minor internal updates and no documented user-facing changes.
...
## [0.11.5](https://github.com/coder/ai-sdk/compare/agent-v0.11.4...agent-v0.11.5) (2026-09-20)

A maintenance release with minor internal updates and no documented user-facing behavior changes.

## [0.11.4](https://github.com/coder/ai-sdk/compare/agent-v0.11.3...agent-v0.11.4) (2026-09-18)

A maintenance release with an internal update and no documented user-facing changes.

## [0.11.3](https://github.com/coder/ai-sdk/compare/agent-v0.11.2...agent-v0.11.3) (2026-09-16)

A maintenance release with internal updates and no documented user-facing changes.

## [0.11.2](https://github.com/coder/ai-sdk/compare/agent-v0.11.1...agent-v0.11.2) (2026-09-15)

A maintenance release with no user-facing changes documented.

## [0.11.1](https://github.com/coder/ai-sdk/compare/agent-v0.11.0...agent-v0.11.1) (2026-09-14)

A patch release with internal maintenance changes and no documented user-facing updates.
...
## [0.9.13](https://github.com/coder/ai-sdk/compare/agent-v0.9.12...agent-v0.9.13) (2026-09-05)

A maintenance release with an internal update and no documented user-facing changes.

## [0.9.12](https://github.com/coder/ai-sdk/compare/agent-v0.9.11...agent-v0.9.12) (2026-09-04)

A maintenance release for the agent package with internal changes and no documented user-facing behavior changes.

## [0.9.11](https://github.com/coder/ai-sdk/compare/agent-v0.9.10...agent-v0.9.11) (2026-09-03)

A maintenance release with internal changes and no documented user-facing updates.

## [0.9.10](https://github.com/coder/ai-sdk/compare/agent-v0.9.9...agent-v0.9.10) (2026-09-02)

Maintenance release with no user-facing changes.

## [0.9.9](https://github.com/coder/ai-sdk/compare/agent-v0.9.8...agent-v0.9.9) (2026-08-31)
