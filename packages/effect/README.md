...
| `@coder/ai-sdk-provider` | `0.4.6`  | `createCoder`, `CoderProviderSettings` (published release, not `workspace:*` — see below)                  |
| `@coder/ai-sdk-sandbox`  | `0.4.9`  | `ensureCoderWorkspace`, `createCoderWorkspace`, `CoderTransport`                                           |
