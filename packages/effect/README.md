...
| `@coder/ai-sdk-provider` | `0.4.14` | `createCoder`, `CoderProviderSettings` (published release, not `workspace:*` — see below)                  |
| `@coder/ai-sdk-sandbox`  | `0.4.17` | `ensureCoderWorkspace`, `createCoderWorkspace`, `CoderTransport`                                           |
