...
| `@coder/ai-sdk-provider` | `0.4.13` | `createCoder`, `CoderProviderSettings` (published release, not `workspace:*` — see below)                  |
| `@coder/ai-sdk-sandbox`  | `0.4.16` | `ensureCoderWorkspace`, `createCoderWorkspace`, `CoderTransport`                                           |
