...
| `@coder/ai-sdk-provider` | `0.4.18` | `createCoder`, `CoderProviderSettings` (published release, not `workspace:*` — see below)                  |
| `@coder/ai-sdk-sandbox`  | `0.4.21` | `ensureCoderWorkspace`, `createCoderWorkspace`, `CoderTransport`                                           |
