...
| `@coder/ai-sdk-provider` | `0.4.23` | `createCoder`, `CoderProviderSettings` (published release, not `workspace:*`)                                           |
| `@coder/ai-sdk-sandbox`  | `0.4.26` | `ensureCoderWorkspace`, `createCoderWorkspace`, `CoderTransport`                                                        |
| `@coder/ai-sdk-agent`    | `0.12.1` | `CoderLanguageModel` (+ `chatId`, `lastSeenMessageId`, dispose), `CoderChatClient`, `classifyTurnAction`, error classes |
