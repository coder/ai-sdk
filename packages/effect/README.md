...
| `@coder/ai-sdk-provider` | `0.4.17` | `createCoder`, `CoderProviderSettings` (published release, not `workspace:*` — see below)                  |
| `@coder/ai-sdk-sandbox`  | `0.4.20` | `ensureCoderWorkspace`, `createCoderWorkspace`, `CoderTransport`                                           |
