...
| `@coder/ai-sdk-provider` | `0.4.9`  | `createCoder`, `CoderProviderSettings` (published release, not `workspace:*` — see below)                  |
| `@coder/ai-sdk-sandbox`  | `0.4.12` | `ensureCoderWorkspace`, `createCoderWorkspace`, `CoderTransport`                                           |
