...
| `@coder/ai-sdk-provider` | `0.4.19` | `createCoder`, `CoderProviderSettings` (published release, not `workspace:*` — see below)                  |
| `@coder/ai-sdk-sandbox`  | `0.4.22` | `ensureCoderWorkspace`, `createCoderWorkspace`, `CoderTransport`                                           |
