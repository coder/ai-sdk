...
| `@coder/ai-sdk-provider` | `0.4.8`  | `createCoder`, `CoderProviderSettings` (published release, not `workspace:*` — see below)                  |
| `@coder/ai-sdk-sandbox`  | `0.4.11` | `ensureCoderWorkspace`, `createCoderWorkspace`, `CoderTransport`                                           |
