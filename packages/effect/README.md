...
| `@ai-sdk/provider`       | `4.0.14` | `LanguageModelV4` spec types (same pin as `@coder/ai-sdk-provider`)                                        |
| `@coder/ai-sdk-provider` | `0.4.15` | `createCoder`, `CoderProviderSettings` (published release, not `workspace:*` — see below)                  |
| `@coder/ai-sdk-sandbox`  | `0.4.18` | `ensureCoderWorkspace`, `createCoderWorkspace`, `CoderTransport`                                           |
