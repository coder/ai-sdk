...
| `@coder/ai-sdk-provider` | `0.4.7`  | `createCoder`, `CoderProviderSettings` (published release, not `workspace:*` — see below)                  |
| `@coder/ai-sdk-sandbox`  | `0.4.10` | `ensureCoderWorkspace`, `createCoderWorkspace`, `CoderTransport`                                           |
