...
| `@ai-sdk/provider`       | `4.0.15` | `LanguageModelV4` spec types (same pin as `@coder/ai-sdk-provider`)                                        |
| `@coder/ai-sdk-provider` | `0.4.16` | `createCoder`, `CoderProviderSettings` (published release, not `workspace:*` — see below)                  |
| `@coder/ai-sdk-sandbox`  | `0.4.19` | `ensureCoderWorkspace`, `createCoderWorkspace`, `CoderTransport`                                           |
