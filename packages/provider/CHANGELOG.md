...
## [0.4.24](https://github.com/coder/ai-sdk/compare/provider-v0.4.23...provider-v0.4.24) (2026-09-26)

A maintenance release with no documented user-facing changes.

## [0.4.23](https://github.com/coder/ai-sdk/compare/provider-v0.4.22...provider-v0.4.23) (2026-09-26)
...
- READMEs were rewritten for readability, with long guides moved into a separate docs/ directory. ([#234](https://github.com/coder/ai-sdk/pull/234))
- Fixed documentation inaccuracies found during the README rewrite. ([#235](https://github.com/coder/ai-sdk/pull/235))
...
## [0.4.20](https://github.com/coder/ai-sdk/compare/provider-v0.4.19...provider-v0.4.20) (2026-09-23)

A maintenance release with internal changes and no documented user-facing modifications.

## [0.4.19](https://github.com/coder/ai-sdk/compare/provider-v0.4.18...provider-v0.4.19) (2026-09-23)

A maintenance release with no user-facing changes.

## [0.4.18](https://github.com/coder/ai-sdk/compare/provider-v0.4.17...provider-v0.4.18) (2026-09-20)

A maintenance release for the provider package with an internal change and no documented user-facing impact.

## [0.4.17](https://github.com/coder/ai-sdk/compare/provider-v0.4.16...provider-v0.4.17) (2026-09-18)

A maintenance release with internal changes and no documented user-facing updates.

## [0.4.16](https://github.com/coder/ai-sdk/compare/provider-v0.4.15...provider-v0.4.16) (2026-09-16)

A maintenance release with no user-facing changes.

## [0.4.15](https://github.com/coder/ai-sdk/compare/provider-v0.4.14...provider-v0.4.15) (2026-09-15)

A maintenance release for the provider package with no user-facing changes documented.

## [0.4.14](https://github.com/coder/ai-sdk/compare/provider-v0.4.13...provider-v0.4.14) (2026-09-14)

A maintenance release with an internal change and no documented user-facing modifications.

## [0.4.13](https://github.com/coder/ai-sdk/compare/provider-v0.4.12...provider-v0.4.13) (2026-09-13)

A maintenance release with internal updates and no documented user-facing changes.

## [0.4.12](https://github.com/coder/ai-sdk/compare/provider-v0.4.11...provider-v0.4.12) (2026-09-09)

A maintenance release with no user-facing changes.

## [0.4.11](https://github.com/coder/ai-sdk/compare/provider-v0.4.10...provider-v0.4.11) (2026-09-05)

A maintenance release with internal changes and no documented user-facing updates.

## [0.4.10](https://github.com/coder/ai-sdk/compare/provider-v0.4.9...provider-v0.4.10) (2026-09-05)
