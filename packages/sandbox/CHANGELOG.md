...
## [0.4.26](https://github.com/coder/ai-sdk/compare/sandbox-v0.4.25...sandbox-v0.4.26) (2026-09-26)

A maintenance release for the sandbox package with a single internal change.

## [0.4.25](https://github.com/coder/ai-sdk/compare/sandbox-v0.4.24...sandbox-v0.4.25) (2026-09-25)

A maintenance release for the sandbox package with internal updates and no documented user-facing changes.
...
## [0.4.22](https://github.com/coder/ai-sdk/compare/sandbox-v0.4.21...sandbox-v0.4.22) (2026-09-23)

A maintenance release for the sandbox package with no user-facing changes documented.

## [0.4.21](https://github.com/coder/ai-sdk/compare/sandbox-v0.4.20...sandbox-v0.4.21) (2026-09-20)

A maintenance release with no notable user-facing changes.

## [0.4.20](https://github.com/coder/ai-sdk/compare/sandbox-v0.4.19...sandbox-v0.4.20) (2026-09-18)

A maintenance release of the sandbox package with no user-facing changes documented.

## [0.4.19](https://github.com/coder/ai-sdk/compare/sandbox-v0.4.18...sandbox-v0.4.19) (2026-09-16)

A maintenance release for the sandbox package with a single internal change.

## [0.4.18](https://github.com/coder/ai-sdk/compare/sandbox-v0.4.17...sandbox-v0.4.18) (2026-09-15)

A maintenance release with no user-facing changes.

## [0.4.17](https://github.com/coder/ai-sdk/compare/sandbox-v0.4.16...sandbox-v0.4.17) (2026-09-14)

A maintenance release for the sandbox package with no user-facing changes.

## [0.4.16](https://github.com/coder/ai-sdk/compare/sandbox-v0.4.15...sandbox-v0.4.16) (2026-09-13)

A maintenance release with internal changes and no documented user-facing updates.

## [0.4.15](https://github.com/coder/ai-sdk/compare/sandbox-v0.4.14...sandbox-v0.4.15) (2026-09-09)

A maintenance release for the sandbox package with no user-facing functional changes.

## [0.4.14](https://github.com/coder/ai-sdk/compare/sandbox-v0.4.13...sandbox-v0.4.14) (2026-09-05)
